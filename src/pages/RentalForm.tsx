  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-5xl mx-auto space-y-6 pb-20">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Nova Locação</h1>
          <p className="text-slate-500 mt-1">Registre um novo faturamento ou contrato de locação.</p>
        </div>
      </div>
          ...
          <div className="bg-emerald-900 rounded-2xl p-6 text-white shadow-xl shadow-emerald-900/20 space-y-6 sticky top-6">
            ...
            <div className="space-y-4 pt-4 border-t border-white/10">
              <div className="space-y-1.5">
                ...
                <input type="text" name="invoice_number" value={formData.invoice_number} onChange={handleChange} placeholder="Gerado automaticamente" className="w-full bg-white/10 border border-white/10 rounded-xl px-4 py-2 text-sm outline-none focus:bg-white/20 transition-all" />
              </div>
              <div className="space-y-1.5">
            ...
            <div className="pt-4 space-y-4">
              <button type="submit" disabled={loading} className="w-full py-4 bg-white text-emerald-900 rounded-xl font-bold text-sm uppercase tracking-widest hover:bg-emerald-50 active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg disabled:opacity-70">
                {loading ? <div className="w-5 h-5 border-2 border-emerald-900/30 border-t-emerald-900 rounded-full animate-spin" /> : 'Confirmar Lançamento'}
              </button>
