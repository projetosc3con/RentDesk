        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col items-center text-center">
            <div className="relative group">
              <div className="w-32 h-32 rounded-full bg-emerald-900 flex items-center justify-center text-white text-4xl font-bold mb-4 shadow-lg overflow-hidden border-4 border-slate-50">
                {photoLoading ? (
            ...
            {formData.photo_url && (
              <button 
                ...
                className="text-xs font-bold text-red-500 hover:text-red-600 uppercase tracking-widest transition-colors mb-4"
              >
                Remover Foto
              </button>
            )}
            ...
            <p className="text-xs font-bold text-emerald-700 uppercase tracking-widest mt-1">{profile?.access_level}</p>
            
            <div className="mt-4 w-full pt-4 border-t border-slate-100">
              <p className="text-xs text-slate-400 font-medium uppercase tracking-widest">E-mail de acesso</p>
              <p className="text-sm text-slate-600 font-medium truncate">{profile?.email}</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            <h3 className="font-bold text-slate-900 flex items-center gap-2 mb-4">
              <span className="material-symbols-outlined text-emerald-900 text-xl">shield_person</span>
              Segurança
            </h3>
            ...
            <button
              ...
              className="w-full py-2.5 bg-slate-50 border border-slate-200 text-slate-700 rounded-xl font-bold text-[10px] uppercase tracking-widest hover:bg-slate-100 hover:border-slate-300 transition-all flex items-center justify-center gap-2"
            >
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100">
              <h3 className="font-bold text-slate-900 flex items-center gap-2">
                <span className="material-symbols-outlined text-emerald-900 text-xl">person_edit</span>
                Dados Pessoais
              </h3>
            </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <h3 className="font-bold text-slate-900 flex items-center gap-2 pt-2">
                <span className="material-symbols-outlined text-emerald-900 text-xl">home</span>
                Endereço
              </h3>
