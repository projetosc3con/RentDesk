...
const ConvertLeadModal: React.FC<ConvertLeadModalProps> = ({ isOpen, onClose, onSuccess, lead }) => {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      setLoading(true); // Manter loading enquanto transiciona se necessário, ou false
      setLoading(false);
    }
  };
          ...
          >
            {success ? (
              <div className="p-12 flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Sucesso!</h3>
                <p className="text-slate-500 dark:text-slate-400 mb-8">
                  O lead <strong>{lead.company_name}</strong> foi convertido em cliente com sucesso.
                </p>
